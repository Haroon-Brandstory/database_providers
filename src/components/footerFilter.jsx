        ...
        <>
            <div className={`relative ${hideFilter ? "hidden" : "block"}`}>
                ...
                <div className="container px-2">
                    <div className="bg-[url('/footer/footerFilterBg.png')] bg-center bg-cover bg-norepeat mx-auto flex flex-col md:flex-row md:justify-between md:items-start gap-10 border-b border-[#222] py-18">
