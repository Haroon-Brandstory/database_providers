...
function ServiceCard({ icon, title, description }) {
    return (
        <div className="bg-white rounded-2xl shadow-lg px-6 py-8 flex flex-col justify-between items-center text-center min-h-[340px] w-[300px] border-4 border-transparent swiper-slide-active:border-[#2C6BFF] transition-all duration-300">
            <div className="mb-4">
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 items-center gap-10">
                    ...
                    <div className="text-start flex flex-col items-center justify-center">
                        <Swiper
                            ...
                            className="mySwiper w-[300px] h-[400px] self-center"
                            onInit={(swiper) => {
                                setTimeout(() => {
                        ...
                        <div className="flex justify-center mt-6 gap-2">
                            <button ref={prevRef} className="custom-swiper-prev cursor-pointer bg-[#2C6BFF] rounded-l-xl px-4 py-2 focus:outline-none">
                                <svg width="24" height="24" fill="none" stroke="#fff" strokeWidth="1"><path d="M15 18l-6-6 6-6" /></svg>
                            </button>
                            <button ref={nextRef} className="custom-swiper-next cursor-pointer bg-[#2C6BFF] rounded-r-xl px-4 py-2 focus:outline-none">
