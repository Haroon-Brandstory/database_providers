            ...
            <div className="container max-w-7xl h-full">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-center ">
                    <div className="md:pb-20">
                        ...
                        <p className="text-[#D0D0D0] text-[18px] font-[400px] mb-4">{t('about.section1.para1', { defaultMessage: 'content-loading-soon' })}</p>
                        <p className="text-[#D0D0D0] text-[18px] font-[400px] mb-4">{t('about.section1.para2', { defaultMessage: 'content-loading-soon' })}</p>
                        <Link href={navHref('/contact-us')}>
                            <button className="relative text-white px-10 py-3 cursor-pointer rounded-full font-medium text-[15px] overflow-hidden z-10 hover:scale-105 transition duration-300 ease-in drop-shadow-[0px_0px_25px_#0133E9CC]">
                                <span className="relative z-10">{t('about.section1.cta', { defaultMessage: 'content-loading-soon' })} </span>
