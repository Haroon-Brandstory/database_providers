        ...
        <section className="bg-white pt-10 pb-20 px-4 md:px-20 text-black text-center flex flex-col items-center">
            ...
            <div className="cards-section-container flex  flex-wrap gap-8 md:gap-12  justify-center items-center mt-10">
                {countCardData.map((item, index) => {
                    ...
                    return (
                        <div key={index} ref={ref} className="bg-[url('/countsection/cardsNormal.png')] hover:bg-[url('/countsection/cardHover.png')] bg-cover bg-center transition-all duration-300 rounded-xl p-6 shadow-md flex flex-col  md:h-[400px] w-full sm:w-[380px] lg:w-[350px]">
